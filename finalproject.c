...
void drawMorHelmet() {
    ...
    glPushMatrix();
    glRotated(90, 0, 1, 0);
    ball(xpos, ypos+height, zpos, radius, 0);
    glPopMatrix();
    
    drawCylinderTube(xpos, ypos, zpos, radius, height, radius, 0);

    glPushMatrix();
    glRotated(270, 0, 1, 0);
    drawHalfCone(xpos, ypos-height, zpos, cone_radius, -cone_height, cone_radius, 0);
    glPopMatrix();
    ...
    glColor3f(0, 1, 1);
    rotation = 325;
    ball(xpos+br*Cos(90-rotation), ypos+height-bh, zpos+br*Sin(90-rotation), ball_radius, 1);
    rotation = 0;
    ball(xpos+br*Cos(90-rotation), ypos+height-bh-.05, zpos+br*Sin(90-rotation), ball_radius, 1);
    rotation = 35;
    ball(xpos+br*Cos(90-rotation), ypos+height-bh, zpos+br*Sin(90-rotation), ball_radius, 1);
}
...
/* Draw a half cone with a shifted top at (x,y,z) scaled by dx,dy,dz and rotated by th */
